...
import { party_narrative as PartyNarrativeModel, Prisma } from '@prisma/client';
  ...
  async updateNarrative(params: {
    where: Prisma.party_narrativeWhereUniqueInput;
    data: Prisma.party_narrativeUpdateInput;
  ...
  @Mutation((returns) => PartyNarrative)
  async deleteNarrative(where: Prisma.party_narrativeWhereUniqueInput): Promise<PartyNarrativeModel> {
