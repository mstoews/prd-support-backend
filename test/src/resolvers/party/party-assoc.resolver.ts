...
import { party_assoc as PartyAssocModel, Prisma } from '@prisma/client';
  ...
  @Mutation((returns) => PartyAssoc)
    async createAssoc(@Args('data', { type: () => PartyAssocInput })  newInstrumentData: Prisma.party_assocCreateInput) {
  ...
  async updateAssoc(params: {
    where: Prisma.party_assocWhereUniqueInput;
    data: Prisma.party_assocUpdateInput;
  ...
  @Mutation((returns) => PartyAssoc)
  async deleteAssoc(where: Prisma.party_assocWhereUniqueInput): Promise<PartyAssocModel> {
